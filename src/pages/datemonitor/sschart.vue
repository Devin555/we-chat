        ...
        <mt-tab-container v-model="selected">
            ...
            <mt-tab-container-item id="2">
                ...
                <div class="historyTab">
                    ...
                    <span :class="{active:!flag}" @click="selectTab2">历史图形数据</span>
                </div>
                <div class="Btn">
                ...
                <div class="historyChartData" v-show="!flag">
                    <div class="selectAll">
                        ...
                        <div style="height:500px;border:1px solid #ccc;paddint:0 20px">
                            <div id="contentChars" style="width: 90%; height: 450px;z-index:99" class="">
    ...
    methods: {
        ...
        selectTab2() {
            ...
            selectInfo(params).then(response => {
                ...
                this.upValue = this.selectList[0].key;
                this.downValue = this.selectList[1].key;
                //图形
                this.dateNow();
                let params1 = {
                    SiteNo: siteNo,
        ...
        //渲染echart
        renderEcharts() {
            var UYinz = this.selectList.find(item => item.key == this.upValue)['text'];
            var DYinz = this.selectList.find(item => item.key == this.downValue)['text'];
            //初始化echarts对象
        ...
        search() {
            if (this.hourListValue == "" || this.hourListValue2 == "") {
                this.$vux.toast.show({ text: "请选择查询时间！" });
            } else {
                if(this.flag){
                    this.getHistoryData();
                }else{
